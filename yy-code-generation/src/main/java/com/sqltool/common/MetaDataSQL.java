...
public class MetaDataSQL {
	 ...
	 * @throws Exception
	 */
	static String insertSQL(ResultSetMetaData metaData) throws Exception{
	...
	static String colBuilder(ResultSetMetaData metaData) throws Exception {

		String newSObj = "\t\nStringBuffer colBuilder = new StringBuffer();\n";
		String sbCol = "colBuilder.append(\" " + colStr(metaData) + "\");\n";
		return newSObj.concat(sbCol)
	 ...
	 * @throws Exception
	 */
	static String colBuilderPage(ResultSetMetaData metaData) throws Exception {
		String newSObj = "\t\nStringBuffer colBuilder = new StringBuffer();\n";
		String sbCol = "colBuilder.append(\" " + colStr(metaData) + "\");\n";
		return newSObj.concat(sbCol)
                .concat("colBuilder.append(whereBuilder(example));\n")
	 ...
	 * @throws Exception
	 */
	static String colBuilderPageCount(ResultSetMetaData metaData) throws Exception {
		String newSObj = "\t\nStringBuffer colBuilder = new StringBuffer();\n";
	 ...
	 * @throws Exception
	 */
	private static String colStr(ResultSetMetaData metaData) throws Exception {
		StringBuffer sb = new StringBuffer();
		sb.append("SELECT ");
	 ...
	 * @throws Exception
	 */
	private static String colStrCount(ResultSetMetaData metaData) throws Exception {
		StringBuffer sb = new StringBuffer();
	...
	static String selectById(ResultSetMetaData metaData) throws Exception {
		StringBuffer sb = new StringBuffer();
		sb.append("SELECT ");
		sb.append(fields(metaData));
		sb.append(" FROM ");
	 ...
	 * 字段信息
	 */
	private static String fields(ResultSetMetaData metaData) throws SQLException {
		StringBuffer sb = new StringBuffer();
	...
	static String whereBuilder(ResultSetMetaData metaData) throws Exception {
	...
	static String updateBuilder(ResultSetMetaData metaData) throws Exception {
		StringBuffer sbWhere = new StringBuffer();
	 ...
	 * @throws Exception
	 */
	static String deleteById(ResultSetMetaData metaData) throws Exception {
		StringBuffer sb = new StringBuffer();
